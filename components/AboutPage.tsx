            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              <div className="w-full md:w-72 flex-shrink-0 space-y-6">
                <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                  ...
                  <h4 className="text-white font-bold mb-1">CASIEC</h4>
                ...
                <div className="p-6 bg-white/5 rounded-2xl border border-white/5">
                  ...
                  <h4 className="text-white font-bold mb-1">GSI (Broastreet DyDX)</h4>
      ...
      <section className="py-24 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="p-8 rounded-3xl bg-white/5 border border-white/10 hover:bg-white/10 transition-all group hover:translate-y-[-5px]">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="flex flex-col items-center p-10 rounded-[2.5rem] bg-white/5 border border-white/5 text-center group hover:bg-nova-900 transition-all duration-500 hover:shadow-[0_0_40px_rgba(79,70,229,0.1)]">
                ...
                <span className="text-xl font-bold text-white mb-4">{val.title}</span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-wrap justify-center items-center gap-16 opacity-50 grayscale hover:grayscale-0 transition-all">
             <div className="flex items-center gap-3">
                ...
                <span className="text-2xl font-black text-white italic">CASIEC</span>
             </div>
             <div className="flex items-center gap-3">
                <div className="bg-purple-600 p-2 rounded-lg"><Network className="h-8 w-8 text-white" /></div>
                <span className="text-2xl font-black text-white italic">GSI STRATEGIC ALLIANCES (Broastreet DyDX)</span>
             </div>
          </div>
        </div>
      </section>
